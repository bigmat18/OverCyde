...
Main: src/Main.o src/Game.o src/GameObj.o src/Rendering/Cube.o src/Rendering/Shader.o src/Rendering/Texture2D.o src/Rendering/IndexBuffer.o src/Rendering/VertexBuffer.o src/Rendering/VertexArray.o src/Handlers/GameObjHandler.o src/Handlers/RendererHandler.o src/Components/RendererComponent.o
